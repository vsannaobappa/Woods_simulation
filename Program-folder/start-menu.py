...
game_sound = pygame.mixer.Sound("sound/spoo-music.mp3")
game_sound.set_volume(0.01)
celebration_sound = pygame.mixer.Sound("sound/audio-id.mp3")
collision_sound_loader = pygame.mixer.Sound("sound/wall-music.mp3")
game_sound.play()
...
def main_menu():
    ...
    menuPicture = pygame.image.load(os.path.join('images', "menu-Image.jpg"))
    click = False
    while True:
        screen.fill((0, 0, 0))
...
def map300_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('images', "300-map.jpg"))

    # person one image
    person_One_Image = pygame.image.load(os.path.join('images', "tomImage.png"))
    person_One_Image.convert_alpha()
    person_One_Image.set_colorkey(alpha)

    # person two image
    person_Two_Image = pygame.image.load(os.path.join('images', "jerry-image.png"))
    person_Two_Image.convert_alpha()
    person_Two_Image.set_colorkey(alpha)

    # init position and draw player
    gameOverImage = pygame.image.load(os.path.join('images', "300-gameover.jpg"))
    ...
    while not is_GameOver:
        ...
        for event in pygame.event.get():
            ...
            if abs(player_one_container.x - player_two_container.x) <= 50 and abs(
                ...
                filename = "results/300output.txt"
...
def map500_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('images', "500-map.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('images', "500-gameover.jpg"))
    ...
    while not is_GameOver:
        ...
        for event in pygame.event.get():
            ...
            if abs(player_one_container.x - player_two_container.x) <= 50 and abs(
                    player_one_container.y - player_two_container.y) <= 50:
                filename = "results/500output.txt"
                Data = str(stepCounter) + "  two players " + "\n"
                record(filename, Data)
                is_GameOver = False
                displayGameOverWindow(gameWindow, gameOverImage=gameOverImage, stepCounter=stepCounter)
...
def vanGogh_Map_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('images', "vanmap-Image.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('images', "forrest-gameover.jpg"))
    ...
    while not is_GameOver:
        ...
        for event in pygame.event.get():
            ...
            if abs(player_one_container.x - player_two_container.x) <= 50 and abs(
                    player_one_container.y - player_two_container.y) <= 50:
                filename = "results/hardoutput.txt"
                Data = str(stepCounter) + "  two players " + "\n"
                record(filename, Data)
                is_GameOver = False
                displayGameOverWindow(gameWindow, gameOverImage=gameOverImage, stepCounter=stepCounter)
...
def Map2560_manuelStimulation():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('images', "2560-map.jpg"))
    ...
    # game over image
    gameOverImage = pygame.image.load(os.path.join('images', "2560-gameover.jpg"))
    ...
    while not is_GameOver:
        ...
        for event in pygame.event.get():
            ...
            if abs(player_one_container.x - player_two_container.x) <= 50 and abs(
                    player_one_container.y - player_two_container.y) <= 50:
                filename = "results/helloutput.txt"
                Data = str(stepCounter) + "  two players " + "\n"
                record(filename, Data)
                is_GameOver = False
                displayGameOverWindow(gameWindow, gameOverImage=gameOverImage, stepCounter=stepCounter)
...
def k_3To5_game():
    ...
    # forrest image
    forrestImage = pygame.image.load(os.path.join('images', "forrest-image.jpg"))
    ...
    while not is_GameOver:
        ...
        for event in pygame.event.get():
            ...
            if abs(player_one_container.x - player_two_container.x) <= 50 and abs(
                ...
                filename = "results/randomMapOutput.txt"
                record(filename, Data)
                is_GameOver = False
                displayGameOverWindow(gameWindow, gameOverImage=gameOverImage, stepCounter=stepCounter)
...
def map300_manuelStimulation_3players():
    ...
    # person three image
    person_Three_Image = pygame.image.load(os.path.join('images', "sandy-Image.png"))
...
def map300_manuelStimulation_4players():
    ...
    # person four image
    person_Four_Image = pygame.image.load(os.path.join('images', "squid-Image.jpg"))
